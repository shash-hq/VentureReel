<header x-data="{ mobileSearchOpen: false }" class="relative h-16 flex-shrink-0 flex items-center justify-between px-4 sm:px-6 m-4 lg:mx-6 lg:mt-6 rounded-2xl bg-white/60 dark:bg-[#1C1A16]/80 backdrop-blur-xl border-b border-white/30 dark:border-white/10 shadow-[0_4px_30px_rgba(0,0,0,0.05)] z-30 sticky top-4 lg:top-6 transition-colors gap-3">
    ...
    <div class="flex items-center gap-2 sm:gap-4 flex-shrink-0">
        ...
        @auth
            ...
            {{-- Upload Button --}}
            <a href="{{ route('videos.create') }}" class="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-semibold rounded-xl text-white bg-amber-500 hover:bg-amber-600 shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 dark:focus:ring-offset-dark-surface transition-all gap-1.5">
